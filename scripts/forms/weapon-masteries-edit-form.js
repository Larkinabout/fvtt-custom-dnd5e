...
import { setConfig, getSettingDefault } from "../configurations/weapon-masteries.js";

const constants = CONSTANTS.WEAPON_MASTERIES;
const configKey = "weaponMasteries";

/**
 * Class representing a form to edit weapon masteries.
 * @extends ConfigEditForm
 */
export class WeaponMasteriesEditForm extends ConfigEditForm {
  /**
