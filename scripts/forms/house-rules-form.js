...
export class HouseRulesForm extends CustomDnd5eForm {
    ...
    static async submit (event, form, formData) {
        ...
        await Promise.all([
            ...
            setSetting(CONSTANTS.EXHAUSTION.SETTING.APPLY_EXHAUSTION_ON_COMBAT_END.KEY, formData.object.applyExhaustionOnCombatEnd),
            ...
            setSetting(CONSTANTS.INITIATIVE.SETTING.REROLL_INITIATIVE_EACH_ROUND.KEY, formData.object.rerollInitiativeEachRound),
