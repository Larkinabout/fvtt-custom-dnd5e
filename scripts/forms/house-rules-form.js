...
export class HouseRulesForm extends CustomDnd5eForm {
    ...
    async getData () {
        ...
        data.applyUnconscious = getSetting(CONSTANTS.UNCONSCIOUS.SETTING.APPLY_UNCONSCIOUS.KEY)
        ...
        data.deathSavesTargetValue = getSetting(CONSTANTS.DEATH_SAVES.SETTING.DEATH_SAVES_TARGET_VALUE.KEY)
    ...
    async _updateObject (event, formData) {
        ...
        await Promise.all([
            ...
            setSetting(CONSTANTS.UNCONSCIOUS.SETTING.APPLY_UNCONSCIOUS.KEY, formData.applyUnconscious),
            ...
            setSetting(CONSTANTS.DEATH_SAVES.SETTING.DEATH_SAVES_TARGET_VALUE.KEY, formData.deathSavesTargetValue),
