...
export function setConfig(settingData = null) {
  ...
  Hooks.callAll("customDnd5e.setArmorSizesConfig", configData);
...
function buildConfigEntry(data) {
  return {
    ...
    ...(data.capacityMultiplier !== undefined && { capacityMultiplier: data.capacityMultiplier }),
    hitDie: data.hitDie,
    ...(data.dynamicTokenScale !== undefined && { dynamicTokenScale: data.dynamicTokenScale }),
