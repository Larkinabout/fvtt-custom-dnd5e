...
/**
 * Register hooks and and load templates.
 */
...
/**
 * Add a listener to the 'Spend Camp Supplies' checkbox in the Long Rest dialog.
 * @param {object} dialog Long Rest dialog
 * @param {object} html Dialog HTML
 * @param {object} options Dialog options
 */
...
/**
 * Refresh the Long Rest dialog based on item creation, deletion, or update.
 * @function
 * @private
...
/**
 * Spend the camp supplies when a Long Rest is taken.
